...
public class ServicioSnacksArchivo implements IServicioSnacks{
    ...
    public ServicioSnacksArchivo(){
        ...
        try{
            ...
            if(existe){
                ...
                salida.close(); //Guarda archivo en disco
    ...
    private List<Snack> obtenerSnacks(){
        ...
        try{
            ...
            for(String linea: lineas){
                ...
                snacks.add(snack); //Se agrega el snack leido a la lista
            }
        }catch(Exception e){
    ...
    public void agregarSnack(Snack snack) {
        //1. se agrega el snack a la lista en memoria
        this.snacks.add(snack);
        //2. Se guarda el snack en el archivo
    ...
    public void mostrarSnack() {
        ...
        //Se muestra la lista de snacks en el archivo
